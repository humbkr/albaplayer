import Layout from 'common/components/layout/Layout.mobile'
...
vi.mock('modules/player/components/Player.mobile', () => ({
  default: () => <div data-testid="player" />,
}))
vi.mock('common/components/layout/ActionBar.mobile', () => ({
  default: () => <div data-testid="action-bar" />,
}))
vi.mock('common/components/layout/MainPanel', () => ({
  default: () => <div data-testid="main-panel" />,
}))
vi.mock('common/components/layout/MainMenu.mobile', () => ({
