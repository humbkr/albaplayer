 ...
 * @param extendedRenderOptions - Optional configuration options for rendering. This includes
 *   `preloadedState` for initial Redux state and `store` for a specific Redux store instance.
 *   Any additional properties are passed to React Testing Library's render function.
 * @returns An object containing the Redux store used in the render, User event API for simulating
 *   user interactions in tests, and all of React Testing Library's query functions for testing
 *   the component.
 */
