...
const en: Translation = {
  ...
  notifications: {
    nowPlaying: 'Now playing {{itemName}}',
    playingNext: '{{itemName}} will play next',
    addedToQueue: '{{itemName}} added to queue',
    addedToPlaylist: '{{itemName}} added to playlist {{playlistName}}',
    addedToNewPlaylist: '{{itemName}} added to new playlist',
    playlistDuplicated: 'Playlist duplicated',
    queueAddedToPlaylist: 'Queue added to playlist {{playlistName}}',
    queueAddedToNewPlaylist: 'Queue added to new playlist',
    removedFromQueue: '{{itemName}} removed from queue',
    removedFromPlaylist: '{{itemName}} removed from playlist',
