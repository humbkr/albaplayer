...
## Server build phase
FROM golang:1.25 AS build_server
...
COPY --from=build_client /app/dist/ /app/frontend/dist/
...
# Create files and folder that can be mounted as volumes
RUN mkdir -p /generated/library /generated/covers \
    && touch /generated/app.log /generated/alba.db
